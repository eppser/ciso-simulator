...
export function renderOperations(g,speed=1,history=false,view='all'){
 ...
 const guide=!g.bought('scanner')&&!cards.some(c=>c.priority<=1)?'<div class="ops-start"><div class="eyebrow">FIRST STEP</div><b>Map your exposure.</b><p>Get a Scanner. Then cover all three uplinks.</p>'+button('threat-program','Open Identify programs ↗','Identify')+'</div>':'';
