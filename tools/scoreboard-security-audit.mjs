...
try{
 let r=await request('/api/run',{org:'startup',ruleset:'ciso-2026-09-v23',scenario:'2026-09-02'},{Origin:'https://untrusted.example'});assert.equal(r.status,403);checks.push('Cross-origin submission blocked');
