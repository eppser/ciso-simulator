...
export default{async fetch(request,env){
 ...
 const endpoint=ruleset==='ciso-2026-09-v22'&&env.GAME_PREVIOUS_EDGE_URL?env.GAME_PREVIOUS_EDGE_URL:ruleset==='ciso-2026-09-v23'&&env.GAME_V23_EDGE_URL?env.GAME_V23_EDGE_URL:ruleset==='ciso-2026-09-v24'&&env.GAME_V24_EDGE_URL?env.GAME_V24_EDGE_URL:env.GAME_EDGE_URL;
