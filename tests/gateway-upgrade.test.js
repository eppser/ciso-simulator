...
const env={GAME_EDGE_URL:'https://verifier.example/v25',GAME_V24_EDGE_URL:'https://verifier.example/v24',GAME_V23_EDGE_URL:'https://verifier.example/v23',GAME_PREVIOUS_EDGE_URL:'https://verifier.example/v22',GAME_GATEWAY_SECRET:'test-only'};
afterEach(()=>vi.unstubAllGlobals());
it.each(['ciso-2026-09-v22','ciso-2026-09-v23','ciso-2026-09-v24','ciso-2026-09-v25','unknown'])('routes %s only to a configured verifier',async ruleset=>{
 ...
 expect(fetch.mock.calls[0][0].pathname).toBe(ruleset==='ciso-2026-09-v22'?'/v22':ruleset==='ciso-2026-09-v23'?'/v23':ruleset==='ciso-2026-09-v24'?'/v24':'/v25');
});
